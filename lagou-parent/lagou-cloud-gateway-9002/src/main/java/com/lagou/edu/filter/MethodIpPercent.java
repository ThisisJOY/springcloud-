...
public class MethodIpPercent {
    ...
    private int calculateTimeWindow;
    private MethodTopPercentileSecond[] topPercentileSeconds;
    ...
    private static class MethodTopPercentileSecond {
        ...
        // 最后一次执行递增的时间信息
        public volatile long lastIncrementTime = -1;
        ...
        public long count() {
            ...
            final long currentTimeMillis = System.currentTimeMillis() - 10000; //10s内
